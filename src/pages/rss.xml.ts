...
export async function GET(context: APIContext): Promise<Response> {
	...
	return rss({
		...
		site: context.site ?? "https://lingerzen.yu-tian.net",
		customData: `<templateTheme>LingerZen</templateTheme>
		<templateThemeVersion>${pkg.version}</templateThemeVersion>
		<templateThemeUrl>https://github.com/yutianlzq/LingerZen</templateThemeUrl>
